...
const HALACHA_STEPS = [
  ...
  {ch:11,hal:6, camera:'zodiacWide', vizMode:'degreeCircle',
  ...
  {ch:11,hal:7, camera:'zodiacWide', vizMode:'zodiacRing', playing:true, speed:1,
  ...
  {ch:11,hal:8, camera:'zodiacWide', vizMode:'degreeToSign',
  ...
  {ch:11,hal:9, camera:'zodiacWide', vizMode:'degreeToSign2',
  ...
  {ch:11,hal:10, camera:'overview', vizMode:'addDegrees',
  ...
  {ch:11,hal:11, camera:'overview', vizMode:'subDegrees',
  ...
  {ch:11,hal:12, camera:'overview', vizMode:'subExample',
  ...
  {ch:11,hal:13, camera:'sunOrbit', vizMode:'epicycleAnim', playing:true, speed:2,
  ...
  {ch:11,hal:14, camera:'sunOrbit', vizMode:'meanVsTrue', playing:true, speed:2,
  ...
  {ch:11,hal:15, camera:'sunOrbit', vizMode:'correctionArrow',
  ...
  {ch:11,hal:16, camera:'overview', vizMode:'jerusalemMap',
  ...
  {ch:11,hal:17, camera:'overview', vizMode:'longitudeShift',
  ...
  {ch:12,hal:1, camera:'sunOrbit', vizMode:'sunMotionTable', playing:true, speed:2,
  ...
  {ch:12,hal:2, camera:'sunOrbit', vizMode:'apogeePoint',
  ...
  {ch:13,hal:1, camera:'sunOrbit', vizMode:'courseCalc',
  ...
  {ch:13,hal:2, camera:'sunOrbit', vizMode:'addSubRule',
  ...
  {ch:13,hal:3, camera:'sunOrbit', vizMode:'addSubRule',
  ...
  {ch:13,hal:4, camera:'sunOrbit', vizMode:'sunCorrTable',
  ...
  {ch:13,hal:5, camera:'sunOrbit', vizMode:'addSubRule',
  ...
  {ch:13,hal:6, camera:'sunOrbit', vizMode:'courseCalc',
   title:'דוגמה — מנה 300°',
  ...
  {ch:13,hal:7, camera:'sunOrbit', vizMode:'interpIntro',
  ...
  {ch:13,hal:8, camera:'overview', vizMode:'interpCalc',
  ...
  {ch:13,hal:9, camera:'sunOrbit', vizMode:'courseCalc',
  ...
  {ch:13,hal:10, camera:'sunOrbit', vizMode:'meanVsTrue', playing:true, speed:2,
  ...
  {ch:14,hal:2, camera:'moonClose', vizMode:'sunMotionTable',
  ...
  {ch:14,hal:4, camera:'moonClose', vizMode:'sunMotionTable',
  ...
  {ch:14,hal:5, camera:'sunOrbit', vizMode:'correctionArrow', playing:true, speed:2,
  ...
  {ch:15,hal:1, camera:'overview', vizMode:'doubleElong', playing:true, speed:2,
  ...
  {ch:15,hal:3, camera:'moonClose', vizMode:'addSubRule',
  ...
  {ch:15,hal:4, camera:'moonClose', vizMode:'correctionArrow',
  ...
  {ch:15,hal:5, camera:'moonClose', vizMode:'addSubRule',
  ...
  {ch:15,hal:6, camera:'moonClose', vizMode:'moonCorrTable',
  ...
  {ch:15,hal:7, camera:'moonClose', vizMode:'addSubRule',
   title:'מסלול מעל 180°',
  ...
  {ch:15,hal:8, camera:'moonClose', vizMode:'courseCalc',
...
function applyStep(){
  ...
  // VizMode — try halacha-specific viz first, then fallback to scene vizMode
  const vizOv = document.querySelector('.obs-3d-model #viz-overlay') ||
    (() => { const d=document.createElement('div'); d.id='viz-overlay';
      d.style.cssText='position:absolute;top:0;left:0;right:0;bottom:0;pointer-events:none;z-index:4';
